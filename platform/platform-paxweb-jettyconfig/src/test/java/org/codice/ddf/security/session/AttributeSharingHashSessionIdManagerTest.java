...
public class AttributeSharingHashSessionIdManagerTest {
  ...
  //    hashSessionIdManager.newSessionId(session);
  ...
  //    hashSessionIdManager.newSessionId(session1);
  ...
  //    hashSessionIdManager.newSessionId(session2);
  //    // make sure we now have 2 clusters
  //    assertEquals(2, hashSessionIdManager.getSessions().size());
  //
  //    // invalidate the 1234 session and make sure that both sessions got killed but the 4321
  // session
  //    // is still good
